namespace Game2DWaterKit.Rendering
{
    ...
    public abstract class RenderingModule
    {
        ...
        protected RenderingModule(bool renderPixelLights, float farClipPlane, bool msaa, bool hdr, int sortingLayerID, int sortingOrder)
        {
        ...
        private static void SetupRenderingCameraInformation(Camera currentRenderingCamera)
        {
            ...
            _renderingCameraInformation.IsIsometric = currentRenderingCamera.orthographic && ((rotationEulerAngles.x != 0f) || (rotationEulerAngles.y != 0f));
